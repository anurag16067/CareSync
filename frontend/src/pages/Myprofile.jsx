...
const Myprofile = () => {
  ...
  //   email:"anurag16067@gmail.com",
  //   phone:"+91 7484800270",
  //   address:{
  //     line1:"823004 Kamrej Char Rasta",
  //     line2:"Surat, Gujarat"
  //   },
  //   gender:"Male",
  //   dob:"2003-07-17"
  ...
  // console.log("my prfile data", userData)
      ...
      
      {
        ...
        ? <label htmlFor="image">
            <div className='inline-block relative cursor-pointer'>
              ...
              <img className='w-10 absolute bottom-12 right-1/2' src={image ? '': assets.upload_icon} alt="" />
            </div>
