...
const AddDoctor = () => {
  // state variables for doctor image upload and doctor image preview
  // state variables for doctor name, email, password, experience, fees, speciality, degree, address1, address2, about
  ...
  // getting backendUrl and aToken from AdminContext
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      //call api to save details of doctor
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='flex-1 flex flex-col gap-1'>
              <p>Experince</p>
              <select onChange={(e) => setExperience(e.target.value)} value={experience} className='border rounded px-3 py-3' name="" id="">
